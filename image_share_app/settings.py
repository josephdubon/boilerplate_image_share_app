"""
Django settings for image_share_app project.
...
SECRET_KEY = 'django-insecure-n0w!!j#_)ceia^m24jfm9pe)271r_1w4gc33i0gj-q@u!hwf6*'
...
ROOT_URLCONF = 'image_share_app.urls'
...
WSGI_APPLICATION = 'image_share_app.wsgi.application'
...
# Serve media files uploaded by uses with the dev server
...
# Returns the corresponding URL for the user_detail
